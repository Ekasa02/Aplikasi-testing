<template>
  <div class="bg-[#33333385] fixed top-0 left-0 right-0 bottom-0 flex items-center sm:justify-center">
    <div class="bg-white p-8 rounded-lg shadow-lg">
      <div class="flex">
        <h1 class="font-Montserrat font-bold text-2xl pr-[300px]">
          Create Project
        </h1>
      ...
      <form @submit.prevent="postProject">
        ...
        <div class="pt-[15px] relative">
          ...
          <div class="relative">
            <select id="platform" v-model="newItem.platform" :disabled="isPlatformDisabled" required
              class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
...
export default {
  ...
  computed: {
    isPlatformDisabled() {
      return this.newItem.type_test === 'automatic';
    },
  },
  methods: {
    closeModal() {

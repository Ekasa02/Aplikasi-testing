    ...
    >
      ...
      <div class="overflow-y-auto max-h-[60vh] pr-5">
        <form @submit.prevent="editProject">
          ...
          <div class="relative pt-[15px]">
            ...
            <div class="flex items-center">
              ...
              >
                ...
                <option
                  v-for="scenarioItem in scenario"
          ...
          <button
            type="submit"
            class="w-full mt-[20px] bg-[#20B2AA] hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            Save
          </button>
        </form>
